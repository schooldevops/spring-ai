...
import com.example.springai.service.SimpleRAGService
import org.springframework.web.bind.annotation.*

/**
 * RAG 컨트롤러
 * 
 * RAG 패턴을 사용한 질문 답변 API를 제공합니다.
 */
@RestController
@RequestMapping("/api/rag")
class RAGController(
    private val ragService: SimpleRAGService,
     ...
     * Body: {"question": "환불 정책은 무엇인가요?", "topK": 3}
     */
    @PostMapping("/ask")
    ...
    /**
     * GET 방식 질문 답변
     * GET http://localhost:8080/api/rag/ask?question=환불 정책은 무엇인가요?&topK=3
     */
    @GetMapping("/ask")
    fun askGet(
     ...
     * Body: {"text": "환불 정책 내용...", "title": "환불 정책", "source": "정책 문서"}
     */
