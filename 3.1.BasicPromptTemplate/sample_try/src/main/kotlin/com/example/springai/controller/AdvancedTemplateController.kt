...
class AdvancedTemplateController(private val chatClientBuilder: ChatClient.Builder) {

    private val chatClient = chatClientBuilder.build()

    /** 이메일 생성 예제 POST http://localhost:8080/api/advanced/email */
    @PostMapping("/email")
    fun generateEmail(@RequestBody request: EmailRequest): String {
        ...
        return chatClient.prompt(prompt).call().content() ?: "응답없음"
    }

    /** 코딩 도우미 예제 POST http://localhost:8080/api/advanced/code-help */
    ...
    /** 번역 서비스 예제 POST http://localhost:8080/api/advanced/translate */
