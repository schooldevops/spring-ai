...
***참고***
spring ai version 1.0.0-M6 로 작성되어 있기 때문에 spring ai 1.1.x 버전이나 1.2.x 버전을 사용할 경우 오류가 발생할 수 있습니다. 
이때에는 다양한 가이드를 찾아 수정하여 활용해 보시길 추천 드립니다. 
요즘은 antigravity등과 같은 다양한 ide가 있으므로 이들을 활용하여 개선하면 좋을듯 합니다~. 
