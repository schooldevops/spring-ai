...
class AdvancedChatController(private val chatModel: ChatModel) {
    ...
    /** 여러 메시지를 포함한 대화 예제 GET http://localhost:8080/api/advanced/conversation */
    ...
    /**
     * 역할 기반 챗봇 예제 POST http://localhost:8080/api/advanced/role Body: {"role": "teacher", "message":
     * "수학을 어떻게 공부하면 좋을까요?"}
     */
    @PostMapping("/role")
    ...
    /**
     * 대화 이력 관리 예제 POST http://localhost:8080/api/advanced/history Body: {"sessionId": "user123",
     * "message": "안녕하세요"}
     */
    @PostMapping("/history")
    ...
    /** 응답 메타데이터 확인 예제 GET http://localhost:8080/api/advanced/metadata */
    @GetMapping("/metadata")
