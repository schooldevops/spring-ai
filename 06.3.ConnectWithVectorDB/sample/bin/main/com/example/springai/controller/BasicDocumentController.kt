...
/**
 * 기본 Document 추가 및 검색 컨트롤러
 * 
 * PGVectorStore를 사용하여 문서를 저장하고 검색합니다.
 */
@RestController
@RequestMapping("/api/documents")
class BasicDocumentController(
    private val vectorStore: VectorStore
) {
    
    /**
     * 단일 문서 추가
     * POST http://localhost:8080/api/documents/add
    ...
    /**
     * GET 방식 검색
     * GET http://localhost:8080/api/documents/search?query=프로그래밍&topK=5
     */
    @GetMapping("/search")
    fun searchGet(
