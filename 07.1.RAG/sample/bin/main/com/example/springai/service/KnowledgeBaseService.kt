...
class KnowledgeBaseService(
     ...
     * 문서 추가
     */
    fun addDocument(text: String, title: String, source: String? = null, metadata: Map<String, Any> = emptyMap()) {
     ...
     * 여러 문서 추가
     */
    fun addDocuments(documents: List<Pair<String, String>>, source: String? = null) {
